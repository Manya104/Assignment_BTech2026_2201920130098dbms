...
// Since we want to maximize the score we will select the biggest numbers first. we first find the unique prime factors count. we will find the left and right max of their prime factor score then op will be 